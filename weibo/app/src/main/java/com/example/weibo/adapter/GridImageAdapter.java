...
public class GridImageAdapter extends
    ...
    private List<LocalMedia> list = new ArrayList<>();      //存储的图片集合
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.recycleritem_deliver_image,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.img_btn_add_img);
...
//                        DebugUtil.i("delete position:", index + "--->remove after:" + list.size());
    ...
    //打开相册时，最多可以选择的数量，等于总数-当前list的size
    public int getRestSelectNum() {
        return selectMax - list.size();
    }
